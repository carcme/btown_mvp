...
/**
 * History entry core data structure
 *
...
public class HistoryEntry {
    ...
    @Ignore
    public HistoryEntry(OverpassQueryResult.Element element) {
        super();
    ...
    public HistoryEntry(long osmId, double lat, double lon, String name, String address,
     ...
     */
    public static class TimeStampComparator implements Comparator<HistoryEntry>, Serializable {
        @Override
