...
public class BookmarkEntry implements Serializable, Parcelable {
    ...
    public BookmarkEntry(long pageId, long timestamp, double lat, double lon, String title, String linkUrl, String extract, String thumbnail, String description, String userComment) {
        this.pageId = pageId;
