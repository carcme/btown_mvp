...
public class NearbyPage {
    ...
    public NearbyPage(@NonNull WikiQueryPage page) {
        title = page.title();
        thumbUrl = page.thumbUrl();
        List<WikiQueryPage.Coordinates> coordinates = page.coordinates();
    ...
    @VisibleForTesting
    NearbyPage(@NonNull String title, @Nullable Location location) {
        this.title = title;
