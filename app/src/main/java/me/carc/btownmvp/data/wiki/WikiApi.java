...
public interface WikiApi {
    ...
    @GET("w/api.php?format=json&action=query&formatversion=2&redirects=1&prop=extracts|coordinates|pageimages|pageterms"
            + "&colimit=20&piprop=thumbnail&pilicense=any&wbptterms=description&exintro=1&explaintext=1"
