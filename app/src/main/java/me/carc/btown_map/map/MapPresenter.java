...
import me.carc.btown_map.Utils.ImageUtils;
import me.carc.btown_map.Utils.MapUtils;
import me.carc.btown_map.Utils.MapZoom;
...
import me.carc.btown_map.common.FusedLocation;
import me.carc.btown_map.common.TinyDB;
import me.carc.btown_map.data.model.OverpassDataTags;
...
import me.carc.btown_map.data.overpass.OverpassApi;
import me.carc.btown_map.data.overpass.OverpassServiceProvider;
import me.carc.btown_map.data.overpass.query.QueryGenerator;
import me.carc.btown_map.data.route.RouteApi;
import me.carc.btown_map.data.route.RouteServiceProvider;
import me.carc.btown_map.data.wiki.WikiApi;
import me.carc.btown_map.data.wiki.WikiQueryPage;
import me.carc.btown_map.data.wiki.WikiQueryResponse;
import me.carc.btown_map.data.wiki.WikiServiceProvider;
...
import me.carc.btown_map.map.overlays.MyDirectedLocationOverlay;
import me.carc.btown_map.map.overlays.route.RouteOverlay;
import me.carc.btown_map.map.search.SearchDialogFragment;
import me.carc.btown_map.map.search.model.Place;
import me.carc.btown_map.map.sheets.MarkerListDialogFragment;
import me.carc.btown_map.map.sheets.RouteDialog;
...
//                    view.onLoadFinish();
    ...
    private void checkRoadDisclaimer(final RouteInfo routeInfo) {
        final TinyDB db = TinyDB.getTinyDB();
    ...
    public void routeToPoi(boolean newRoute, final RouteInfo routeInfo) {
        ...
        if (!TinyDB.getTinyDB().getBoolean(ROUTE_DISCLAIMER_ACCEPTED)) {
