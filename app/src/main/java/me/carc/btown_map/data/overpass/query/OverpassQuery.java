...
import me.carc.btown_map.data.overpass.output.OutputModificator;
import me.carc.btown_map.data.overpass.output.OutputOrder;
import me.carc.btown_map.data.overpass.output.OutputVerbosity;
...
public class OverpassQuery extends AbstractOverpassQuery {
    ...
    public OverpassQuery output(int limit) {
        return output(OutputVerbosity.BODY, OutputModificator.CENTER, OutputOrder.QT, limit);
    }
